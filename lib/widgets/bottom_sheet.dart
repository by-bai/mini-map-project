...
class MapBottomSheet extends StatefulWidget {
  ...
  const MapBottomSheet({Key? key, required this.marker}) : super(key: key);
...
class _MapBottomSheetState extends State<MapBottomSheet> {
    ...
    return Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: <Widget>[
          ...
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(widget.marker.lat.toString())
          ]),
          const SizedBox(height: 10),
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text(
            ...
            Text(widget.marker.lon.toString())
          ]),
          const SizedBox(height: 10),
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            const Text(
  ...
  void _saveLocation() {
    ...
    final String text = '${widget.marker.title} added to your saved locations.';
