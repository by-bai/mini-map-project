...
class NavigationDrawer extends StatefulWidget {
  NavigationDrawer(
      {Key? key, required this.controller, required this.animateCamera})
      : super(key: key);
...
class NavigationDrawerState extends State<NavigationDrawer> {
  ...
  Widget build(BuildContext context) {
    ...
    const imageUrl =
        'https://images.unsplash.com/uploads/14110635637836178f553/dcc2ccd9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80';
    return Drawer(
        child: Material(
            color: color,
                      ...
                      onClicked: () async {
                        ...
                        if (mapService.runAnimateCamera) {
                          widget.animateCamera(
                              mapService.cameraPosition, mapService.cameraZoom);
